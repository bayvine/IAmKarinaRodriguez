      ...
      <Section>
        <div className="flex flex-col gap-10 xl:flex-row xl:items-start xl:justify-between">
          ...
          {prismic.isFilled.image(slice.primary.image) ? (
            <Reveal
              className="overflow-hidden bg-night relative aspect-[16/14] overflow-hidden bg-night sm:aspect-square lg:w-[500px] lg:h-[540px] lg:aspect-auto xl:h-[450px] xl:w-[500px]"
              delay={0.28}
