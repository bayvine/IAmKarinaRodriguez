          ...
          >
            <div className="relative overflow-hidden">
              <div className="relative min-h-[34rem] overflow-hidden sm:min-h-[38rem] lg:min-h-0 lg:aspect-[16/8] xl:aspect-[2.75/1]">
                ...
                <div className="relative z-10 flex min-h-[34rem] flex-col justify-end p-6 pt-16 sm:min-h-[38rem] sm:p-8 sm:pt-20 lg:absolute lg:inset-x-0 lg:bottom-0 lg:min-h-0 lg:p-10 lg:pt-12 xl:p-12">
