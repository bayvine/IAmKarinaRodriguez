...
const Hero: FC<HeroProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      ...
      <Section className="flex min-h-[100svh] flex-col justify-end pb-10 pt-80 sm:pb-12 sm:pt-40 lg:pb-14 lg:pt-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-end lg:gap-8">
          <div className="mx-auto max-w-3xl lg:mx-0">
            {prismic.isFilled.richText(slice.primary.title) ? (
              <div className="max-w-full sm:max-w-4xl sm:text-center lg:text-left">
                <PrismicRichText
                  components={{
                    heading1: ({ children }) => (
                      <StaggeredTextReveal
            ...
            {prismic.isFilled.richText(slice.primary.subtitle) ? (
              <HeroRaiseReveal
                className="mx-auto mt-5 max-w-2xl border-t border-rose-white/14 pt-5  font-sans text-base text-rose-white/78 sm:mt-6 sm:pt-6 sm:text-lg lg:mx-0 lg:border-t-0 lg:pt-0 lg:text-left"
                delay={0.76}
              >
                <PrismicRichText
                  components={{
